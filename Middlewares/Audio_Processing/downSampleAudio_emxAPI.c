...
/* Include Files */
#include "downSampleAudio_emxAPI.h"
...
emxArray_real_T *emxCreateND_real_T(int numDimensions, const int *size)
{
  ...
  int i;
  int numEl;
  emxInit_real_T_Down(&emx, numDimensions);
  numEl = 1;
...
{
  emxInit_real_T_Down(pEmxArray, numDimensions);
}

/*
 * File trailer for downSampleAudio_emxAPI.c
 *
 * [EOF]
 */
